...
/**
 * Test whether expand properties works right in policy files. Test works right only if property expandProperties in ${java.home}/lib/security/java.security is
 * set to true (it is default setting in java).
 *
 * @author olukas
 */
