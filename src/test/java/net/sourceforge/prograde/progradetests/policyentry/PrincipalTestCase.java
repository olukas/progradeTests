...
public class PrincipalTestCase {
    ...
    /*
     * Test whether subject with two TestingPrincipal principals, but only one of them is right can't read java.home which has grant for one of that
     * TestingPrincipal and one different TestingPrincipal
     *
     */
    @Test
