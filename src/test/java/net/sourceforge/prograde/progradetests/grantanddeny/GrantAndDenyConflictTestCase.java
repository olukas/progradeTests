...
public class GrantAndDenyConflictTestCase {
    ...
    /*
     * Test conflict between grant and deny entry when deny entry is subset of grant entry and deny priority is set. 
     * Test access to specified file and also to any file which has access set due to * in policy file 
     */
    @Test
    ...
    /*
     * Test conflict between grant and deny entry when deny entry is subset of grant entry and grant priority is set.
     * Test access to specified file and also to any file which has access set due to * in policy file 
     */
    @Test
    ...
    /*
     * Test conflict between grant and deny entry when grant entry is subset of deny entry and deny priority is set.
     * Test access to specified file and also to any file which has access set due to * in policy file 
     */
    @Test
    ...
    /*
     * Test conflict between grant and deny entry when grant entry is subset of deny entry and grant priority is set.
     * Test access to specified file and also to any file which has access set due to * in policy file 
     */
    @Test
